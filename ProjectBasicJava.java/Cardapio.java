...
public class Cardapio {
	...
	public static void main(String[] args) {
		...
		int escolha;
		String[][] CadastroUsuario = new String[3][7]; // Matriz para cadastrar os usuários
		String[][] Restaurantes = {
				{ "Paladar", "7895446", "Marmitas", "R$20,00" },
				{ "Primavera", "4547812", "Pizzas", "R$70,00" },
				{ "Don Capone", "31461512", "Massas", "R$55,00" }
		};
		do {
			...
			switch (escolha) {
				...
				case 1:
					...
					break;
				case 2:
					System.out.println(ListarRestaurantes(Restaurantes));
					break;
				case 3:
	...
	public static String ListarRestaurantes(String[][] Restaurantes) {
		System.out.println("-----------------------------------------------------");
		System.out
				.println(
